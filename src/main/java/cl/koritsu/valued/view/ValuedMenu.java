...
public final class ValuedMenu extends CustomComponent {
    ...
    private Component buildTitle() {
        Label logo = new Label("<strong>Valued</strong> Dashboard",
                ContentMode.HTML);
...
//	            }
    ...
    public final class ValoMenuItemButton extends Button {
        ...
        public ValoMenuItemButton(final ValuedViewType view) {
            this.view = view;
